...
export default function CreateAccountPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Navigate to car info page
      router.push("/onboarding/car-owner/car-info")
    }, 1500)
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="container mx-auto px-4 py-8 max-w-md">
        <h1 className="text-3xl font-bold text-center text-green-800 mb-8">Create an Account</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-center space-x-4 pt-6">
            ...
            <button
              ...
              className="px-8 py-3 bg-green-800 text-white rounded-full hover:bg-green-700 disabled:opacity-70"
            >
              {isLoggingIn ? (
